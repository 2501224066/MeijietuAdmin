...
function createDOMPurify() {
  ...
  /**
   * Sanitize
   * Currency method providing core sanitation functionality
   *
  ...
  /**
   * Currency method to set the configuration once
   * setConfig
   *
  ...
  /**
   * Currency method to remove the configuration
   * clearConfig
   *
   */
  ...
  /**
   * Currency method to check if an attribute value is valid.
  ...
  /**
   * AddHook
   * Currency method to add DOMPurify hooks
   *
  ...
  /**
   * RemoveHook
   * Currency method to remove a DOMPurify hook at a given entryPoint
  ...
  /**
   * RemoveHooks
   * Currency method to remove all DOMPurify hooks at a given entryPoint
   *
  ...
  /**
   * RemoveAllHooks
   * Currency method to remove all DOMPurify hooks
   *
   */
